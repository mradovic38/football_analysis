...
def main():
    ...
    obj_tracker = ObjectTracker(
        ...
        conf=.1                                             # Object Detection confidence threshold
    )
    ...
    process_video(processor,                                # Created FootballVideoProcessor object
                  video_source='input_videos/08fd33_6.mp4', # Video source (in this case video file path)
                  output_video='output_videos/test.mp4',    # Output video path (Optional)
